...
The phone game's Help is here: **Help** in the title, pause and System menus opens its Instructions, ten topics of the imported text, its Controls and its Credits. The loading screen carries one of its Tips & Tricks. M.A.I. says her one-time pieces the first time their moment comes - the gate, the dock, radiation and pressure, the booster she wants, the catch that got away, the hold that is full - and the station cards of the collection are shown when they are earned. There are three save slots and the autosave, chosen on Load and on Save game at a station. A hull hit buzzes a pad or a handheld (Controls · Gamepad · Vibration).
